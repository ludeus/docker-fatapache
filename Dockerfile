...
RUN apt update && DEBIAN_FRONTEND=noninteractive \
    ...
    php7.2-mbstring php7.2-xmlrpc php7.2-xml php7.2-intl php7.2-zip php7.2-curl php7.2-pgsql php7.2-sqlite3 php7.2-mysql php7.2-gd \
    php-pear php-imagick php7.2-imap php-memcache php7.2-pspell php7.2-recode php7.2-xsl php-gettext php7.2-zmq \
    sqlite3 \
